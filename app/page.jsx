...
export default function Home() {
  ...
  return (
    <>
      <section
        className={`w-full min-h-screen bg-fixed bg-center bg-no-repeat bg-cover bg-homeBg dark:bg-homeTwoBg-dark md:pb-16 ${
          darkmode && "dark"
        }`}
      >
        <div className="container grid grid-cols-12 md:gap-10 justify-between lg:mt-[220px]">
          <div className="col-span-12 lg:col-span-4 lg:h-screen lg:sticky top-44">
            <div className="w-full mb-6 lg:mb-0 mx-auto relative bg-white text-center dark:bg-[#111111] px-6 rounded-[20px] mt-[180px] md:mt-[220px] lg:mt-0 ">
              <div className="w-[240px] absolute left-[50%] transform -translate-x-[50%] h-[240px] drop-shadow-xl mx-auto rounded-[20px] -mt-[140px]">
                anh
              </div>
              <div className="pt-[100px] pb-8">
                ...
                <div className="p-7 rounded-2xl mt-7 bg-[#F3F6F6] dark:bg-[#1D1D1D]">
                  <div className="flex py-2.5 border-b border-[#E3E3E3] dark:border-[#3D3A3A]">
                    <span className="flex-shrink-0 socialbtn bg-white dark:bg-black text-[#E93B81] shadow-md p-3">
                      <svg
                        stroke="currentColor"
                        fill="currentColor"
                        strokeWidth={0}
                  ...
                  <div className="flex py-2.5 border-b border-[#E3E3E3] dark:border-[#3D3A3A]">
                    <span className="flex-shrink-0 socialbtn bg-white dark:bg-black text-[#6AB5B9]  shadow-md p-3">
                      <svg
                        stroke="currentColor"
                        fill="currentColor"
                        strokeWidth={0}
                  ...
                  <div className="flex py-2.5 border-b border-[#E3E3E3] dark:border-[#3D3A3A]">
                    <span className="flex-shrink-0 socialbtn bg-white dark:bg-black text-[#FD7590] shadow-md p-3">
                      <svg
                        stroke="currentColor"
                        fill="currentColor"
                        strokeWidth={0}
                  ...
                  <div className="flex py-2.5 undefined">
                    <span className="flex-shrink-0 socialbtn bg-white dark:bg-black text-[#C17CEB] shadow-md p-3">
                      <svg
                        stroke="currentColor"
                        fill="currentColor"
                        strokeWidth={0}
                  ...
                  <button className="inline-flex items-center mx-auto bg-gradient-to-r from-[#FA5252] to-[#DD2476] duration-200 transition ease-linear hover:bg-gradient-to-l from-[#DD2476] to-[#fa5252ef] px-8 py-3 text-lg text-white rounded-[35px] mt-6">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
          ...
          <div className="col-span-12 lg:col-span-8 ">
            ...
            <div className="lg:rounded-2xl bg-white dark:bg-[#111111]">
              <div>
                <div className="px-2 pt-12 md:py-12 sm:px-5 md:px-10 lg:px-14 dark:text-white">
